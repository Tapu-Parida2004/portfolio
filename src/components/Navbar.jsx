...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full h-20 bg-gradient-to-r from-cyan-500 to-blue-500 text-white z-50 shadow-lg">
      <div className="flex justify-between items-center h-full px-4">
        ...
        <motion.h1
          ...
          className="font-signature text-4xl animate-pulse  "
        >
          Tapu
        </motion.h1>
        ...
        <ul className="hidden md:flex space-x-8">
          {links.map(({ id, name, icon, to }) => (
            <motion.li
              ...
              className="flex items-center space-x-2 font-medium text-gray-800 hover:text-white hover:scale-110 duration-300 cursor-pointer"
            >
              <Link
                to={to}
                smooth={true}
        ...
        <motion.button
          ...
          className="md:hidden text-gray-800  duration-300 hover:scale-105 hover:rotate-180 hover:text-white "
        >
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-gray-800"
      >
        {/* Close Button */}
        <motion.button
        ...
        {/* Mobile Links */}
        <ul className="flex flex-col items-center justify-center space-y-6 h-full text-blue-300 ">
          {links.map(({ id, name, icon, to }) => (
            <motion.li
              key={id}
