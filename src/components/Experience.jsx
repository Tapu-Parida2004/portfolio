      ...
      <div className="max-w-screen-lg mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 mt-4">
            While I am a fresher, my skills and projects speak for my dedication
        ...
        <div className="mt-12">
          ...
          {/* Filter Dropdown */}
          <div className="mb-8">
            <label className="text-gray-300 text-lg mr-4" htmlFor="percentageFilter">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {visibleSkills.map(({ id, name, level, percentage, icon }) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gray-700 p-4 rounded-lg shadow-lg hover:scale-105 duration-300"
              >
                <div className="flex items-center space-x-4 mb-4">
                  <img
                    src={icon}
                    alt={name}
                    className="w-12 h-12 object-cover rounded-md hover:scale-110 duration-300 hover:border-2 border-blue-300"
                  />
                  <div>
            ...
            ({
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.8 }}
                  viewport={{ once: true }}
                  className="bg-gray-700 p-6 rounded-lg shadow-lg mb-4"
                >
