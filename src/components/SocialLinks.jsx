...
const SocialLinks = () => {
  const links = [
    ...
    },
    {
      id: 2,
      name: "Github",
      icon: <FaGithub size={20} className="text-blue-400" />,
      href: "https://github.com/Tapu-Parida2004",
    },
    {
      id: 3,
      name: "Mail",
      icon: <HiOutlineMail size={20} className="text-blue-400" />,
      href: "mailto:tapuparida232@gmail.com",
    },
    {
      id: 4,
      name: "Resume",
      icon: <BsFillPersonLinesFill size={20} className="text-blue-400" />,
      href: "/MyResume.pdf",
      style: "rounded-br-md",
      download: true,
    },
      ...
      <ul>
        {links.map(({ id, name, icon, href, style, download }) => (
          <motion.li
            ...
            className={`flex justify-between items-center w-40 h-14 px-4  bg-gray-800 ml-[-100px] hover:ml-[0px] hover:rounded-md hover:duration-300 border-blue-300 border-b-[1px] ${style}`}
          >
            <a
              href={href}
