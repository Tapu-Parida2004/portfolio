...
export const projects = [
  {
    ...
    description: "A fully responsive e-commerce website with a modern UI/UX.",
    image: ecommerce,
  ...
  },
  {
    id: 3,
    title: "Hacker News",
    description: "A Hacker News App with search and paginate.",
    image: hacker_news,
  ...
  },
  {
    ...
    title: "Backroads",
    description:
      "A task management application to organize and track tasks efficiently.",
    image: backroads,
  ...
  },
  {
    ...
    description:
      "A Grocery-bud App that provides add grocery into list, edit and delete.",
    image: grocery,
  ...
  },
  {
    id: 6,
    title: "Random User",
    description: "A platform for creating and sharing blogs with rich content.",
    image: random_user,
  ...
  },
  {
    ...
    description: "A website with seamless pagination .",
    image: paginate,
